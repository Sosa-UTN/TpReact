  ...
  return (
    <>
        <div className="hero-section-div">
            <img src="img/herosection-1.png" alt="imagen" srcset=""/>
            <div>
        ...
        <div className="seccion-cards">
            ...
            <div className="contenedor-cards">
                <div className="index-card">
                    <img src="img/cintas-raso-card.png" alt=""/>
                    <div>
                ...
                <div className="index-card">
                    <img src="img/puntillas-broderie-card.png" alt=""/>
                    <div>
                ...
                <div className="index-card">
                    <img src="img/pasamaneria-pompones-card.png" alt=""/>
                    <div>
